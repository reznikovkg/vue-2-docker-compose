  ...
  <div class="item">
    ...
    <div class="item__info">
      ...
      <div class="item__prices">
        <div class="item__prices__current">{{ item.price.currentPrice }} ₽</div>
        <div class="item__prices__discount" v-if="item.price.originalPrice">
    ...
    <div class="item__count">
      <div class="item__count__amount">
        ...
        <div class="item__count__amount__number">{{ item.selectCount }}</div>
        <button
          class="item__count__amount__button"
          @click="$emit('changeCount', 1)"
        >
...
export default {
  ...
  computed: {
    ...
    discountPersent() {
      return (
        ((this.item.price.originalPrice - this.item.price.currentPrice) /
