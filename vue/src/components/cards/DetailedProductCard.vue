<template>
    <div class="product-card-detail">
      <div class="product-card-detail__thumbnails">
        <img v-for="(image, index) in card.images" :key="index" :src="image" @mouseover="changeMainImage(image)" alt="" class="thumbnail">
      </div>
  ...
  .product-card-detail {
    ...
    &__delete-card-btn:hover {
      background-color: #0056b3;
    }
    &__img-container {
      width: 60%;
      height: auto;
      padding-bottom: calc((1801 / 2600) * 60%);
