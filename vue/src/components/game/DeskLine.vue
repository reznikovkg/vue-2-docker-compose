<template>
  <div :class="['desk', generateStyleByType('desk')]">
    ...
    <div class="desk__cards">
      <GameCard v-for="(card, index) in cards" :key="index" :strength="card.strength" />
    </div>
  </div>
</template>
    ...
    cards: {
      ...
      validator (value) {
        return Array.isArray(value)
          && value.every(item => typeof item.strength === "number");
      },
    },
  },
  methods: {
